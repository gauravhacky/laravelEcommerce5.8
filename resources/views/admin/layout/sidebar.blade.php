            ...
            <div class="sidebar">
               ...
               <ul class="sidebar-menu">
                 ...
                 <li class="treeview">
                     ...
                     <ul class="treeview-menu">
                        <li><a href="preport.html">Add</a></li>
                        <li><a href="creport.html">List</a></li>
                        <li><a href="group.html">Edit</a></li>
                     </ul>
                  </li>
                  <li class="treeview">
                 ...
                 <li class="treeview">
                     <a href="#">
                     <i class="fa fa-shopping-basket"></i><span>Manage Cms</span>
                     <span class="pull-right-container">
                     <i class="fa fa-angle-left pull-right"></i>
                     </span>
                     </a>
                     <ul class="treeview-menu">
                        <li><a href="salary.html">Home</a></li>
                        <li><a href="hourly.html">About us</a></li>
                        <li><a href="managesal.html">Faq</a></li>
                        <li><a href="empsallist.html">Privacy Policy</a></li>
                        <li><a href="mpayment.html">Terms & Conditions</a></li>
                     </ul>
                  </li>
                 <li class="treeview">
                     <a href="#">
