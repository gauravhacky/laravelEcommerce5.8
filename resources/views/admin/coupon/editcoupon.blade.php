                  ...
                  <div class="col-sm-12">
                     <div class="panel panel-bd lobidrag">
                        ...
                        <div class="panel-body">
                           <form class="col-sm-6" id="addproform" enctype="multipart/form-data" action="{{route('update.coupon',$couponDetail->id)}}" method="post">
                               @csrf
                            <div class="form-group">
                                 <label>Coupon Code</label>
                            <input type="text" class="form-control" placeholder="coupon code"  name="coupon_code" value="{{$couponDetail->coupon_code}}">
                              </div>
                              <div class="form-group">
                                 <label>Ammount</label>
                                 <input type="number" class="form-control" placeholder="Enter ammount Price" name="ammount" value="{{$couponDetail->amount}}">
                              </div>
                              <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="datepicker" placeholder="Enter expiry date" name="expiry_date" value="{{$couponDetail->expiry_date}}">
                             </div>
